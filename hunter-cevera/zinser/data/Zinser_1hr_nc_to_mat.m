...
file = append(pathname, 'Zinser_SizeDist_calibrated-26-6_1hr.nc'); % Zinser data
...
num_obs = num_days*24+1;
counts_as_matrix = zeros(26,num_obs);
for i = 1:num_obs
...
volbins = size_bounds(1:26).';

N_dist = round(w_obs(1:num_obs,:).' .* counts_as_matrix);

save Zinser_data_1hr Edata volbins N_dist;
